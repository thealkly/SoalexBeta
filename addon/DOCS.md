...
## Akku-Regelung — wie Solalex misst und einstellt

Solalex regelt deinen Akku mit einem PI-Regler. Beim ersten Setup misst der Wizard
...
Position. Wenn keine Messung vorliegt, regelt Solalex mit einem konservativen
...
1–3 s). Solalex erkennt das automatisch beim Reaktionstest und schlägt dir eine
...
zwischen zwei Schreibvorgängen unbemerkt aufintegrieren würde. Solalex friert den
...
- **Rückmeldungs-Modus pro Gerät:** Die Rückmeldungs-Prüfung lässt sich
  ...
  - *Mit Rückmeldung* (Standard) — Solalex prüft nach jedem Befehl den
    Leistungs- bzw. Echo-Sensor. Empfohlen für getestete Hardware.
  - *Nur Soll-Wert-Echo* — Solalex prüft nur, ob die Soll-Wert-Zahl
  ...
  - *Ohne Rückmeldung* — Solalex prüft **nicht**, ob die Hardware den
